...
class DOutlinedButtonTheme {
  ...
  static final lightOutlinedButtonTheme = OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      ...
      textStyle: const TextStyle(
          fontSize: 16, color: DColors.black, fontWeight: FontWeight.w600),
      padding: const EdgeInsets.symmetric(
          vertical: DSizes.buttonHeight, horizontal: 20),
  ...
  static final darkOutlinedButtonTheme = OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      ...
      side: const BorderSide(color: DColors.borderPrimary),
      textStyle: const TextStyle(
          fontSize: 16, color: DColors.textWhite, fontWeight: FontWeight.w600),
      padding: const EdgeInsets.symmetric(
          vertical: DSizes.buttonHeight, horizontal: 20),
      shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(DSizes.buttonRadius)),
